...
// Alternative — get by class (requires import)
...
See the dedicated [Events Reference](/grid/events/) for the complete catalog of all events (core + plugin), detail types, cancelable events, and listening patterns.
