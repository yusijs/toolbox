...
For the complete event reference — including listening patterns per framework, cancelable events, and all plugin events — see the **[Events Reference](/grid/events/)** page.
