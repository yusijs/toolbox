...
**Solution**: Use feature imports (recommended) or check your plugin import path:

```typescript
// ✅ Recommended: features API (side-effect imports)
import '@toolbox-web/grid/features/selection';
import '@toolbox-web/grid/features/filtering';

// ✅ Alternative: plugin imports (advanced usage)
...
1. **Feature imported**: Use the features API (recommended):

```typescript
// ✅ Recommended — features API
import '@toolbox-web/grid/features/selection';
...
2. **Or plugin instantiated**: When using the plugins API, pass `new Plugin()`, not the class:
...
When using the features API, dependencies are resolved automatically. When using the plugins API directly:
