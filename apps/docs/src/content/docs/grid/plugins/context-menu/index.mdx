...
import ContextMenuEventsDemo from '@components/demos/context-menu/ContextMenuEventsDemo.astro';
...
- [`ContextMenuItem`](/grid/plugins/context-menu/interfaces/contextmenuitem/) — Menu item definition (id, label, icon, action, submenus, etc.)
- [`ContextMenuParams`](/grid/plugins/context-menu/interfaces/contextmenuparams/) — Context passed to action callbacks (row, column, value, selection, etc.)
- [`ContextMenuConfig`](/grid/plugins/context-menu/interfaces/contextmenuconfig/) — Plugin configuration options
