...
import EditingConditionalDemo from '@components/demos/editing/EditingConditionalDemo.astro';
...
<ShowSource file="demos/editing/EditingConditionalDemo.astro">
  <EditingConditionalDemo />
</ShowSource>
