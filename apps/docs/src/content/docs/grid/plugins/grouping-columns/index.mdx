...
HTML strings returned from the renderer are automatically sanitized (scripts and event-handler attributes are stripped) — see [Production Checklist › Sanitize User-Supplied Data](/grid/guides/production-checklist/#sanitize-user-supplied-data).
