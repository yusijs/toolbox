...
import PrintToolbarButtonDemo from '../../../../../components/demos/print/PrintToolbarButtonDemo.astro';
import PrintPortraitOrientationDemo from '../../../../../components/demos/print/PrintPortraitOrientationDemo.astro';
...
const handlePrint = async () => {
  await gridRef.value?.element?.getPluginByName('print')?.print();
};
</script>
...
- **[Selection](../?path=/grid/plugins/selection/)** — Print selected rows only
