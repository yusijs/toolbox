...
Enable the **Server-side sorting** toggle in the demo above to see `sortHandler` in action. When a user clicks a sortable column header, your handler is called instead of the built-in sorting logic.
