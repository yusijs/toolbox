...
- **[Server-Side](/grid/plugins/server-side/)** — Tree requires the full hierarchy to flatten and manage expansion state. Server-side lazy loading provides rows in blocks and cannot deliver nested children on demand.
:::
