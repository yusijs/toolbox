...
> 💡 **Optional Enhancement:** When [ReorderPlugin](/grid/plugins/reorder-columns/) is also loaded, columns in the visibility panel become draggable for reordering.
...
Set `visible: false` on columns you want hidden by default. The feature provides a UI and API for toggling column visibility at runtime.
