{/* AI-CONTEXT: For structured, AI-optimized documentation about this plugin,
    ...
    — section: "### FilteringPlugin" (under "## Plugin Configuration Reference") */}
...
<Canvas of={FilteringStories.TypeSpecificFilters} withToolbar />
...
- **[Server-Side Data](../?path=/docs/grid-plugins-server-side-data--docs)** — Server-side filtering via `filterHandler`
